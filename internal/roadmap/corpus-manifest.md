...
Next concrete step: continue with writer/page operations or add a guarded form
fill wrapper over `binas` after appearance/refusal semantics are pinned by tests.
